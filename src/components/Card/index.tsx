...
export default function Card({ desc, title, image, special }: CardProps) {
    ...
    return (
        <div className={`sm:w-[350px] w-full h-[300px] relative rounded-[20px] border px-12 py-16 border-gray-300 my-shadow flex items-center justify-center ${special ? 'sm:-translate-y-8 grad-4' : 'sm:bg-white'}`}>
